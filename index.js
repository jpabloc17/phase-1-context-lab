...
function hoursWorkedOnDate(dateStamp){
    const timeIn = this.timeInEvents.find(function(element){
        return element.date === dateStamp
    });    
    const timeOut = this.timeOutEvents.find(function(element){
        return element.date === dateStamp
    });
...
function calculatePayroll(arrayOfEmployee){
    const totalPayroll = arrayOfEmployee.reduce(function(total, employeeRecord){
